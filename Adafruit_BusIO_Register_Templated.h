#ifndef Adafruit_BusIO_Register_Templated_h
#define Adafruit_BusIO_Register_Templated_h
...
class Adafruit_BusIO_Register_Templated {
public:
  Adafruit_BusIO_Register_Templated(Adafruit_I2CDevice_Templated<TWire> *i2cdevice, uint16_t reg_addr,
                          uint8_t width = 1, uint8_t byteorder = LSBFIRST,
                          uint8_t address_width = 1);

  Adafruit_BusIO_Register_Templated(Adafruit_SPIDevice *spidevice, uint16_t reg_addr,
                          Adafruit_BusIO_SPIRegType type, uint8_t width = 1,
                          uint8_t byteorder = LSBFIRST,
                          uint8_t address_width = 1);

  Adafruit_BusIO_Register_Templated(Adafruit_I2CDevice_Templated<TWire> *i2cdevice,
...
private:
  Adafruit_I2CDevice_Templated<TWire> *_i2cdevice;
 ...
 */
template<class TWire>
class Adafruit_BusIO_RegisterBits_Templated {
public:
  Adafruit_BusIO_RegisterBits_Templated(Adafruit_BusIO_Register_Templated<TWire> *reg, uint8_t bits,
                              uint8_t shift);
  bool write(uint32_t value);
  uint32_t read(void);

private:
  Adafruit_BusIO_Register_Templated<TWire> *_register;
 ...
 */
template<class TWire>
Adafruit_BusIO_Register_Templated<TWire>::Adafruit_BusIO_Register_Templated(Adafruit_I2CDevice_Templated<TWire> *i2cdevice,
                                                 uint16_t reg_addr,
                                                 uint8_t width,
                                                 uint8_t byteorder,
 ...
 */
template<class TWire>
Adafruit_BusIO_Register_Templated<TWire>::Adafruit_BusIO_Register_Templated(Adafruit_SPIDevice *spidevice,
                                                 uint16_t reg_addr,
 ...
 */
template<class TWire>
Adafruit_BusIO_Register_Templated<TWire>::Adafruit_BusIO_Register_Templated(
    Adafruit_I2CDevice_Templated<TWire> *i2cdevice, Adafruit_SPIDevice *spidevice,
 ...
 */
template<class TWire>
bool Adafruit_BusIO_Register_Templated<TWire>::write(uint8_t *buffer, uint8_t len) {
 ...
 */
template<class TWire>
bool Adafruit_BusIO_Register_Templated<TWire>::write(uint32_t value, uint8_t numbytes) {
  if (numbytes == 0) {
    numbytes = _width;
  }
  if (numbytes > 4) {
 ...
 */
template<class TWire>
uint32_t Adafruit_BusIO_Register_Templated<TWire>::read(void) {
 ...
 */
template<class TWire>
uint32_t Adafruit_BusIO_Register_Templated<TWire>::readCached(void) { return _cached; }
 ...
 */
template<class TWire>
bool Adafruit_BusIO_Register_Templated<TWire>::read(uint8_t *buffer, uint8_t len) {
  uint8_t addrbuffer[2] = {(uint8_t)(_address & 0xFF),
                           (uint8_t)(_address >> 8)};
 ...
 */
template<class TWire>
bool Adafruit_BusIO_Register_Templated<TWire>::read(uint16_t *value) {
  if (!read(_buffer, 2)) {
    return false;
  }
 ...
 */
template<class TWire>
bool Adafruit_BusIO_Register_Templated<TWire>::read(uint8_t *value) {
  if (!read(_buffer, 1)) {
    return false;
  }
 ...
 */
template<class TWire>
void Adafruit_BusIO_Register_Templated<TWire>::print(Stream *s) {
  uint32_t val = read();
  s->print("0x");
  s->print(val, HEX);
}
 ...
 */
template<class TWire>
void Adafruit_BusIO_Register_Templated<TWire>::println(Stream *s) {
  print(s);
  s->println();
}
 ...
 * touching other bits
 *    @param  reg The Adafruit_SoftBusIO_Register which defines the bus/register
 *    @param  bits The number of bits wide we are slicing
 *    @param  shift The number of bits that our bit-slice is shifted from LSB
 */
template<class TWire>
Adafruit_BusIO_RegisterBits_Templated<TWire>::Adafruit_BusIO_RegisterBits_Templated(
    Adafruit_BusIO_Register_Templated<TWire> *reg, uint8_t bits, uint8_t shift) {
  _register = reg;
  _bits = bits;
  _shift = shift;
}
 ...
 */
template<class TWire>
uint32_t Adafruit_BusIO_RegisterBits_Templated<TWire>::read(void) {
 ...
 */
template<class TWire>
bool Adafruit_BusIO_RegisterBits_Templated<TWire>::write(uint32_t data) {
  uint32_t val = _register->read();
 ...
 */
template<class TWire>
uint8_t Adafruit_BusIO_Register_Templated<TWire>::width(void) { return _width; }
 ...
 */
template<class TWire>
void Adafruit_BusIO_Register_Templated<TWire>::setWidth(uint8_t width) { _width = width; }
 ...
 */
template<class TWire>
void Adafruit_BusIO_Register_Templated<TWire>::setAddress(uint16_t address) {
  _address = address;
}
 ...
 */
template<class TWire>
void Adafruit_BusIO_Register_Templated<TWire>::setAddressWidth(uint16_t address_width) {
  _addrwidth = address_width;
}
